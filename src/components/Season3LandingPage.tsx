...
const IconBrain = () => (
  <svg {...baseIconProps} className="h-5 w-5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M9.5 2A2.5 2.5 0 0 1 12 4.5V7a1 1 0 0 0 1 1h1a2.5 2.5 0 1 1 0 5h-1a1 1 0 0 0-1 1v2.5a2.5 2.5 0 1 1-5 0V14a1 1 0 0 0-1-1H5a2.5 2.5 0 1 1 0-5h1a1 1 0 0 0 1-1V4.5A2.5 2.5 0 0 1 9.5 2Z" />
  </svg>
);
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <section className="relative overflow-hidden rounded-2xl border border-blue-500/20 bg-gradient-to-br from-gray-900 to-gray-950 p-6 sm:p-10 shadow-xl">
        ...
        <div className="relative z-10">
          ...
          <p className="text-gray-300/95 max-w-2xl text-sm sm:text-base mb-6">
            Live analysis of spec popularity and performance from real high-key runs. Explore AI-powered tier lists, performance predictions, tier signals, comps that time keys, and weekly shifts.
          </p>
          <div className="flex flex-wrap gap-3">
            <Link to="/ai-tier-list" className="inline-flex items-center gap-2 rounded-lg bg-blue-600 hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-400 text-white px-4 py-2.5 text-sm font-semibold shadow transition">
              <span>AI Tier List</span>
              <span>→</span>
            </Link>
            <Link to="/meta-evolution" className="inline-flex items-center gap-2 rounded-lg border border-gray-600/60 bg-gray-800/70 hover:border-blue-400/40 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-400 text-gray-100 px-4 py-2.5 text-sm font-semibold transition">
      ...
      <section className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <Link to="/ai-predictions" className="group rounded-xl border border-gray-700 bg-gray-800/70 hover:border-blue-400/40 p-5 transition-colors hover:shadow-md hover:-translate-y-0.5 transform">
          <div className="mb-2 inline-flex h-9 w-9 items-center justify-center rounded-lg bg-orange-500/15 text-orange-300 border border-orange-400/20">
            <IconBrain />
          </div>
          <h3 className="text-lg font-semibold text-gray-100">AI Predictions</h3>
          <p className="text-gray-400 text-sm">Performance forecasts and analysis.</p>
        </Link>
        <Link to="/ai-tier-list" className="group rounded-xl border border-gray-700 bg-gray-800/70 hover:border-blue-400/40 p-5 transition-colors hover:shadow-md hover:-translate-y-0.5 transform">
          <div className="mb-2 inline-flex h-9 w-9 items-center justify-center rounded-lg bg-yellow-500/15 text-yellow-300 border border-yellow-400/20">
            <IconList />
          </div>
          <h3 className="text-lg font-semibold text-gray-100">AI Tier List</h3>
          <p className="text-gray-400 text-sm">Ranked specializations by AI.</p>
        </Link>
      </section>
